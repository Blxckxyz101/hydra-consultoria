        ...
        <div className="rounded-3xl border border-red-500/20 bg-black/60 backdrop-blur-2xl p-8 sm:p-10 text-center shadow-[0_0_80px_rgba(239,68,68,0.12)]">
          ...
          <div className="space-y-3">
            ...
            <motion.a
              ...
              className="flex items-center justify-center gap-2 w-full py-3.5 rounded-2xl bg-white/5 border border-white/10 text-sm text-muted-foreground hover:text-white hover:bg-white/10 transition-all"
            >

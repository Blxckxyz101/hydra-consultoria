  ...
  return (
    <div className="space-y-8 max-w-3xl mx-auto">
      ...
      <motion.a
        ...
        style={{
          background: "linear-gradient(135deg, rgba(18,140,67,0.18) 0%, rgba(37,211,102,0.10) 60%, rgba(18,140,67,0.14) 100%)",
        ...
        onMouseEnter={e => {
          ...
          el.style.background = "linear-gradient(135deg, rgba(18,140,67,0.28) 0%, rgba(37,211,102,0.18) 60%, rgba(18,140,67,0.22) 100%)";
          el.style.borderColor = "rgba(37,211,102,0.60)";
          el.style.boxShadow = "0 4px 40px rgba(37,211,102,0.20), 0 0 0 1px rgba(37,211,102,0.15)";
        }}
        onMouseLeave={e => {
          const el = e.currentTarget as HTMLElement;
          el.style.background = "linear-gradient(135deg, rgba(18,140,67,0.18) 0%, rgba(37,211,102,0.10) 60%, rgba(18,140,67,0.14) 100%)";
          el.style.borderColor = "rgba(37,211,102,0.30)";
          el.style.boxShadow = "0 0 0 0 rgba(37,211,102,0)";
        }}
      >
        {/* Glow accent */}
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
          style={{ background: "radial-gradient(ellipse at 20% 50%, rgba(37,211,102,0.12) 0%, transparent 70%)" }} />

        <div className="relative flex items-center gap-5 p-5 sm:p-6">
          {/* WhatsApp icon with ring */}
          <div className="relative shrink-0">
            ...
            <div className="relative w-14 h-14 rounded-2xl flex items-center justify-center"
              style={{ background: "linear-gradient(135deg, #128C43 0%, #25D366 100%)", boxShadow: "0 4px 20px rgba(37,211,102,0.35)" }}>
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 mb-0.5">
              <span className="text-[10px] font-bold uppercase tracking-[0.45em]" style={{ color: "#25D366" }}>Contato Oficial</span>
            ...
            <div className="font-bold text-base text-white leading-tight">Falar no WhatsApp</div>
            <div className="text-xs mt-1" style={{ color: "rgba(37,211,102,0.70)" }}>
              Suporte rápido · atendimento personalizado
            </div>
          </div>

          {/* Arrow */}
          <ExternalLink className="w-5 h-5 shrink-0 opacity-40 group-hover:opacity-80 transition-opacity" style={{ color: "#25D366" }} />
        </div>

        {/* Bottom accent line */}
        <div className="h-[2px] w-full opacity-30 group-hover:opacity-60 transition-opacity"
          style={{ background: "linear-gradient(90deg, transparent 0%, #25D366 30%, #128C43 70%, transparent 100%)" }} />
      </motion.a>
